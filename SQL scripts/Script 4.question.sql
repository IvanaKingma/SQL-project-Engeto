...
--- ziskame prumerne rocni ceny potravin a mezd za jednotlive roky
SELECT 
	product_name, 
...
---vytvoreni dane tabulky, abychom mohli uzit joiny---
...
---tabulka joinovana, urcujici navyseni cen potravin a platu v prubehu let---
...
---posledni sloupec ukazuje meziocni navyseni cen oprati mzdam
...
GROUP BY `year`,
	new_year
ORDER BY difference_in_increase_betw_price_salary desc;
